...
export const GET_CHECK_ANSWER_TO_QUESTION_START = 'GET_CHECK_ANSWER_TO_QUESTION_START';
export const GET_CHECK_ANSWER_TO_QUESTION_SUCCESS = 'GET_CHECK_ANSWER_TO_QUESTION_SUCCESS';
export const GET_CHECK_ANSWER_TO_QUESTION_FAILURE = 'GET_CHECK_ANSWER_TO_QUESTION_FAILURE';

// let urlApi = "https://lambda-study-app.herokuapp.com"; // deprecated
const urlApi = process.env.REACT_APP_QUIZ_API;

export const checkAnswerToQuestion = (quizId, questionId, responseId) => (dispatch) => {
