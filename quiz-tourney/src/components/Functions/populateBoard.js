			...
			if (j === 0) {
				...
				if (linesOfText.length > 1) {
					for (let t = 0; t < linesOfText.length; t++) {
						ctxText.fillText(
							`${linesOfText[t]}`,
							titleSquareWidth * i + titleSquareWidth / 2 - ctxText.measureText(linesOfText[t]).width / 2,
					...
					ctxText.fillText(
						`${quizzes[i].title}`,
						titleSquareWidth * i + titleSquareWidth / 2 - ctxText.measureText(quizzes[i].title).width / 2,
				...
				ctxText.fillText(
					`$${pointsValue}`,
					titleSquareWidth * i - 5 + titleSquareWidth / 2 - ctxText.measureText(pointsValue).width / 2,
